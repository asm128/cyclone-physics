...
namespace cyclone {
...
#if 0
    #define SINGLE_PRECISION	// Defines we're in single precision mode, for any code that needs to be conditionally compiled.
    // Defines a real number precision. Cyclone can be compiled in single or double precision versions. By default single precision is provided.
    typedef	float			real;
    ...
    #define real_epsilon	FLT_EPSILON		// Defines the number e on which 1+e == 1 **/
