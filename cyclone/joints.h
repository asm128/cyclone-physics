...
namespace cyclone {
	...
	struct Joint : public ContactGenerator {
		...
		double		Error;	// Holds the maximum displacement at the joint before the joint is considered to be violated. This is normally a small, epsilon value. It can be larger, however, in which case the joint will behave as if an inelastic cable joined the bodies at their joint locations.
