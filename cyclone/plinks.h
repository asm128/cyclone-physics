...
namespace cyclone {
    ...
    public:
		...
		real								currentLength				()															const;	// Returns the current length of the link.
	...
	public:
		real								maxLength;					// Holds the maximum length of the cable.
		real								restitution;				// Holds the restitution (bounciness) of the cable.
